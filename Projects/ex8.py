...
semi_annual_raise = 0.00
while semi_annual_raise == 0:
    print ("Please enter your semi annual raise: ") #request user input
    Input = input() #input semi_annual_raise
    try:
        semi_annual_raise = float(Input) #check that the input is a number
    except:
        print ("Please enter your semi annual raise as a number.") #if the input isn't a number then give the user a polite error message
