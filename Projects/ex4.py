...
print(f"He is {my_height_ft} feet and {my_height_in} inches tall ({my_height} inches total), or {my_height_m} metres tall ({my_height_cm} centimetres).")
print(f"He weighs {my_weight} pounds, or {my_weight_kg} kilograms.")
